...
of the cycles it had an access in the DCU. None of the traffic it is waiting
for turns out to be necessary.}
\label{fig:stall}
\end{figure}
...
$1.122\times$ at a fixed 60~MHz clock -- for 66\,ps of slack, which is less than
this design's run-to-run variation. It also removes the case in which the
extension was slower than having no cache at all.
